...
const otherCompanies: Company[] = [
 ...
 },
 {
  ...
  employees: "72",
  location: "São Paulo, SP",
  description: "Plataforma de pagamentos e crédito com presença em 5 países da América Latina.",
  matchScore: 84,
  logo: "FT",
 ...
 },
 {
  ...
  description: "Rede de clínicas e consultórios com mais de 20 unidades e gestão integrada.",
  matchScore: 79,
  logo: "SD",
 ...
 },
 {
  ...
  employees: "56",
  location: "Vitória, ES",
  description: "Plataforma de gestão e venda de imóveis com mais de 5000 propriedades listadas.",
  matchScore: 66,
  logo: "IM",
 ...
 },
 {
  ...
  employees: "48",
  location: "Manaus, AM",
  description: "Agência de turismo de experiência com foco em ecoturismo e turismo de aventura.",
  matchScore: 63,
  logo: "TR",
 ...
 },
 {
  ...
  employees: "64",
  location: "Goiânia, GO",
  description: "Produção de alimentos orgânicos com certificação internacional e distribuição nacional.",
  matchScore: 81,
  logo: "AG",
 ...
 },
 {
  ...
  employees: "118",
  location: "São Paulo, SP",
  description: "Brand de moda casual com presença em 50 lojas e forte presença em e-commerce.",
  matchScore: 91,
  logo: "MD",
 ...
 },
 {
  ...
  employees: "55",
  location: "Belo Horizonte, MG",
  description: "Centro de cursos profissionalizantes com mais de 8000 alunos certificados por ano.",
  matchScore: 74,
  logo: "ED2",
 ...
 },
 {
  ...
  employees: "85",
  location: "Recife, PE",
  description: "Startup de desenvolvimento de aplicativos com clientes em Europa e América do Norte.",
  matchScore: 87,
  logo: "TK",
 ...
 },
 {
  ...
  description: "Rede de academias premium com personal training e metodologia proprietária.",
  matchScore: 71,
  logo: "FT2",
 ...
 {
  id: 116,
  name: "Confidencial #116",
  sector: "Beleza",
  revenue: "R$ 9M",
  employees: "38",
  location: "Brasília, DF",
  description: "Franquia de salões de beleza com serviços completos e programa de fidelização.",
  matchScore: 58,
  logo: "BZ",
 ...
 {
  id: 117,
  name: "Confidencial #117",
  sector: "Mobilidade",
  revenue: "R$ 21M",
  employees: "93",
  location: "Brasília, DF",
  description: "Serviço de mobilidade urbana com frotas de bicicletas e scooters elétricas.",
  matchScore: 75,
  logo: "MB",
 ...
 {
  id: 118,
  name: "Confidencial #118",
  sector: "Alimentação",
  revenue: "R$ 19M",
  employees: "71",
  location: "Curitiba, PR",
  description: "Rede de restaurantes especializados em culinária contemporânea com ambiência premium.",
  matchScore: 77,
  logo: "RS",
 ...
 {
  id: 119,
  name: "Confidencial #119",
  sector: "Software",
  revenue: "R$ 12M",
  employees: "48",
  location: "Porto Alegre, RS",
  description: "Empresa de desenvolvimento de software custom para setor público e privado.",
  matchScore: 69,
  logo: "SW",
 ...
 {
  id: 120,
  name: "Confidencial #120",
  sector: "Saúde",
  revenue: "R$ 16M",
  employees: "54",
  location: "Fortaleza, CE",
  description: "Laboratório de análises clínicas com mais de 50 unidades de coleta.",
  matchScore: 80,
  logo: "LB",
     ...
     <div className={`flex gap-2 ${isMobile ? 'w-full' : 'flex-grow'}`}>
      <div className="relative flex-grow flex items-center gap-2">
       ...
       <Input 
        ...
        className={`pl-10 h-11 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 dark:shadow-slate-900/30 focus:ring-2 focus:ring-primary/20 transition-all`}
        value={searchTerm}
      ...
      {isMobile && (
       <Button 
        ...
        className="h-11 bg-white text-slate-900 border-slate-200 whitespace-nowrap font-medium transition-colors hover:bg-slate-50 dark:bg-slate-800 dark:text-white dark:border-slate-700 dark:hover:bg-slate-700 px-3"
    ...
    <div className={`grid ${isMobile ? 'grid-cols-1' : 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3'} gap-6`}>
     {filteredCompanies.length === 0 ? (
      ...
      filteredCompanies.map((company) => (
       ...
       >
        <Card className="border-slate-200 dark:border-slate-800 dark:bg-slate-900 hover: dark:hover:shadow-slate-800/70 hover:border-slate-300 dark:hover:border-slate-700 transition-all duration-300 h-full overflow-hidden cursor-pointer" data-testid={`card-company-${company.id}`}>
