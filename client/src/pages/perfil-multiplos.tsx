    ...
    <div className="max-w-6xl mx-auto">
          ...
          >
           <Card
            className={`h-full transition-all duration-300 cursor-pointer border-2 ${
             isActive
              ? `${config.color} text-white border-opacity-50 `
     ...
     {!showAddNew ? (
      <div className="flex justify-center">
       <Button
        size="lg"
        className="gap-2 px-8 h-12 text-base font-semibold bg-primary hover:bg-primary/90 text-white transition-colors dark:shadow-slate-900/50"
        ...
        {newProfileOptions.map((option, index) => {
         ...
         return (
          <motion.div
           ...
           transition={{ delay: index * 0.1 }}
          >
           <Card className="h-full border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 hover: transition-all duration-300 flex flex-col overflow-hidden group">
            <div
