        ...
        <div className="w-full lg:w-1/2 bg-white dark:bg-slate-900 flex items-center justify-center p-8 lg:p-24 relative">
          <div className="w-full max-w-sm space-y-8">
            <div className="text-center lg:text-left">
              ...
              <h1 className="text-3xl font-bold text-foreground dark:text-white tracking-tight">Criar conta</h1>
              <p className="text-muted-foreground dark:text-slate-400 mt-2">Preencha seus dados para começar.</p>
            </div>
