  ...
  <Layout>
   <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div className="mb-8">
     ...
     <Card className="rounded-xl border text-card-foreground p-0 bg-card dark:bg-[#0F172B] dark:border-slate-800 overflow-hidden" data-testid="card-settings-preferences">
    ...
    <div className="mb-8">
     ...
     <Card className="rounded-xl border text-card-foreground p-0 bg-card dark:bg-[#0F172B] dark:border-slate-800 overflow-hidden" data-testid="card-settings-notifications">
      <div className="divide-y divide-border dark:divide-slate-800">
       <SettingItem
        icon={Bell}
    ...
    <div className="mb-8">
     ...
     <Card className="rounded-xl border text-card-foreground p-0 bg-card dark:bg-[#0F172B] dark:border-slate-800 overflow-hidden" data-testid="card-settings-privacy">
      <div className="divide-y divide-border dark:divide-slate-800">
       <SettingItem
        icon={Share2}
    ...
    <div className="mb-8">
     ...
     <Card className="rounded-xl border text-card-foreground p-0 bg-card dark:bg-[#0F172B] dark:border-slate-800 overflow-hidden" data-testid="card-settings-account">
