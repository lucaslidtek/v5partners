    ...
    <Layout>
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl font-bold text-foreground mb-2">Quase Pronto!</h1>
        ...
        <div className="mb-8">
          <div className="flex justify-between text-sm font-medium mb-2">
            <span className="text-foreground">Progresso do Perfil</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold text-foreground flex items-center gap-2">
             ...
             <div className="space-y-3">
                <Card className="border border-border shadow-sm relative overflow-hidden bg-card">
                  <div className="absolute top-0 right-0 bg-muted px-2 py-0.5 text-[10px] font-bold uppercase text-muted-foreground rounded-bl-lg">
                    Alta Prioridade
                  </div>
                  <CardContent className="p-4">
                    <div className="flex items-start gap-3 mb-3">
                      ...
                      <div>
                        <p className="font-medium text-foreground">Comprovação de Renda</p>
                        <p className="text-xs text-muted-foreground">Para acessar oportunidades premium</p>
                      </div>
                    </div>
                ...
                <Card className="border border-border shadow-sm bg-card">
                   <div className="absolute top-4 right-4">
                      <span className="bg-destructive/10 text-destructive text-[10px] font-bold px-2 py-0.5 rounded-full">Crítica</span>
                   </div>
                   <CardContent className="p-4">
                    <div className="flex items-start gap-3 mb-3">
                      ...
                      <div className="pr-12">
                        <p className="font-medium text-foreground">Verificação de Identidade</p>
                        <p className="text-xs text-muted-foreground">Validação obrigatória para contato com vendedores</p>
                      </div>
                    </div>
        ...
        <Card className="bg-secondary/10 border-secondary/20 mb-8">
          <CardContent className="p-6">
            <div className="flex items-center justify-center mb-4">
              <span className="text-2xl mr-2">🚀</span>
              <h3 className="text-lg font-bold text-foreground">Benefícios do Perfil Completo</h3>
            </div>
            <p className="text-center text-muted-foreground text-sm mb-6">Veja o que você ganha ao finalizar sua verificação</p>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <Button variant="outline" className="flex-1 h-12 text-base border-border bg-background" onClick={() => setLocation("/dashboard")}>
